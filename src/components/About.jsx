...
const About = () => {
    return (
        <div className='lg:px-8 mt-52 font-sans text-[#a8b2d1]'>
            ...
            <div className='grid-layout-2 mt-10 animated animatedFadeInUp fadeInUp animation-delay-700'>
                <div>
                    <div>
                    ...
                    <div className='mt-2'>
                        I've worked on multiple open source projects and created a few interesting <AnchorLink href='#projects' offset={130}>projects</AnchorLink> that have taught me a lot of writing better and optimized codes.
                    </div>
                </div>
            ...
            <div className='mt-5 animated animatedFadeInUp fadeInUp animation-delay-750'>
                <h2>
                    Here are a few languages I've worked with before:
                </h2>
                <Languages items={languages} />
            </div>
            <div className='mt-5 animated animatedFadeInUp fadeInUp animation-delay-800'>
                <h2>
